...
export const OPENAI_RESPONSES_FORMAT_ERROR_ZH =
  '當前 provider 返回的不是 OpenAI Responses API 格式。請確認 base_url 填寫到 /v1（不要追加 /responses），並確認該服務支持 /v1/responses；如果只支持 /v1/chat/completions，請選擇 OpenAI / 兼容 Chat Completions。'
