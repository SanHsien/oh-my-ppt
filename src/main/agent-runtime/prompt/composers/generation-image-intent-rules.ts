...
export const buildGenerationImageIntentRules = (args: {
  ...
  return [
    ...
    'Before writing HTML, decide independently whether this page needs one image: request it when the active style skill\'s 配圖 strategy matches the page and an identifiable subject, scene, evidence, or atmosphere improves the message. The strategy is a positive signal, not a quota.',
