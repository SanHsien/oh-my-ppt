...
export const formatSkillUsageRequirement = (skillName: RequiredProductSkillName): string =>
  `Use the DeepAgents Skills System entry for ${skillName}; read that skill's SKILL.md before applying this capability.`

export const resolveLayoutSkillName = (input: SlideSizePreset): RequiredProductSkillName => {
...
export const getRequiredProductSkillNamesForSlideSize = (
