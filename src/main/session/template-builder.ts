/** Session HTML template builders for the multi-page preview architecture. */
...
export const buildPageScaffoldHtml = (page: {
  ...
  const safeTitle = escapeHtml(page.title || `第 ${page.pageNumber} 頁`)
  return `<!doctype html>
<html lang="zh-CN">
  <head>
    <meta charset="UTF-8" />
        ...
        <div class="ppt-page-content">
          <section class="scaffold-card" data-page-scaffold="1" data-placeholder-page="1">
            <main data-block-id="content" data-role="content">
              ...
              <div class="scaffold-hint">等待模型填充這一頁內容</div>
            </main>
          </section>
        </div>
      </div>
...
<html lang="zh-CN">
  ...
  <body>
    <div class="ppt-layout">
      <section class="ppt-stage">
        <div id="frameViewport" class="ppt-preview-viewport">
          ${frameElements}
          <div class="ppt-empty">暫無頁面，請先生成 /&lt;pageId&gt;.html 內容</div>
        </div>
      </section>
    </div>
    ...
    <div class="ppt-controls">
      <button class="ppt-control-btn" id="prevBtn">上一頁</button>
      <div class="ppt-indicator" id="indicator"></div>
      <button class="ppt-control-btn" id="nextBtn">下一頁</button>
      <button class="ppt-control-btn" id="tabsBtn">頁面目錄</button>
