...
- Do NOT mention "確認並生成" / "Confirm & Generate". You are still collecting information.

When the user has confirmed requirements and explicitly requests design/generation (e.g. "設計吧", "開始生成", "出大綱", "好，開始吧", "可以，規劃一下"), you MUST:
