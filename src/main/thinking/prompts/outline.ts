...
- If the user asks to 完善細節, 補充細節, 豐富內容, expand, or flesh out an already complete outline, update affected pages in batches with pageStart and call update_context_document with stage set to "draft" after the final batch has commit=true.
