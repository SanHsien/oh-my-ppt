...
const MODEL_PROVIDER_LINKS = [
  ...
  { label: 'GLM (智譜)', url: 'https://open.bigmodel.cn' },
  { label: 'Qwen (通義千問)', url: 'https://bailian.console.aliyun.com/' },
      ...
      <CardHeader className="flex-row items-center justify-between p-5 pb-3">
        <div>
          <CardTitle className="flex items-center gap-1.5 text-base">
            ...
            <Link to="/help?tab=models" className="ml-1 text-xs font-medium text-[#2f7f8f] underline-offset-4 transition-colors hover:text-[#1f6472] hover:underline">{t('settings.modelHelpDocs')}</Link>
          </CardTitle>
          {activeModelConfig && (
