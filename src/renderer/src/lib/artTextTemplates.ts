...
export const ART_TEXT_TEMPLATES = [
  ...
  { id: 'neon-glow', label: '02 賽博霓虹', defaultText: 'NEON CYBER' },
  { id: 'shadow-3d', label: '03 硬核3D', defaultText: '3D DEPTH' },
  { id: 'wave-text', label: '04 波浪律動', defaultText: 'WAVE 動感' },
  { id: 'stroke-text', label: '05 科技描邊', defaultText: 'HOLLOW OUT' },
  { id: 'typewriter', label: '06 經典打字機', defaultText: 'Typing...' },
  { id: 'glitch', label: '07 故障干擾', defaultText: 'GLITCH FX' },
  { id: 'fire-text', label: '08 烈焰灼燒', defaultText: 'BLAZING HOT' },
  { id: 'glass-text', label: '09 毛玻璃高級感', defaultText: 'Frosted Glass' },
  { id: 'rotate-3d', label: '10 立體旋轉', defaultText: '3D ROTATE' },
  { id: 'rainbow', label: '11 彩虹變色龍', defaultText: 'RAINBOW' },
  { id: 'liquid', label: '12 液態幻彩', defaultText: 'LIQUID ART' },
  { id: 'bounce-text', label: '13 彈性跳躍', defaultText: 'BOUNCE!' },
  { id: 'float-shadow', label: '14 懸浮夢境', defaultText: 'FLOAT SOFTLY' },
  { id: 'metal-text', label: '15 金屬質感', defaultText: 'METAL BRUSH' }
] as const
