...
/**
 * 獨立 HTML 編輯器頁面（/edit-html）。與 session-edit 完全解耦：
 * 內存編輯（零 DB / 零 git），工作文件落 <storage>/html-editor/。
 * 組合自有 HtmlEditorCanvas（document 模式）+ HtmlEditorGuidesOverlay + HTML 專用檢視面板。
 */
