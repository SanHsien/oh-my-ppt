...
const LAYOUT_MASTER_TEMPLATE_DEFINITIONS: LayoutMasterTemplateDefinition[] = [
  {
    ...
    descriptionZh: '單一核心主張，配合剋制的輔助信息。',
  ...
  },
  {
    ...
    descriptionZh: '標題進入完整視覺場，搭配剋制的背景信息。',
    preview: 'image-focus',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '標題主導的敘事內容，閱讀路徑明確。',
    preview: 'editorial',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '兩個相關內容組，以有意的不對稱形成層級。',
    preview: 'two-column',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '核心數字或圖表主導，配合簡潔證據。',
    preview: 'metric-grid',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '一個主證據面，將解釋融入圖表或數據視覺中。',
    preview: 'chart-side',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '圍繞共用維度緊湊比較，並給出一個建議。',
    preview: 'two-column',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '多個選項收束到一個決定性差異或選擇。',
    preview: 'versus',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '階段推進的時間線，突出一個關鍵節點。',
    preview: 'timeline',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '將階段轉化爲一條具有空間感的時間旅程。',
    preview: 'timeline',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '一箇中心概念，搭配分組的支撐信息。',
    preview: 'process',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '方向明確的流程，清楚表達因果關係。',
    preview: 'process',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '用分層、交接或運行平面表達流程機制。',
    preview: 'process',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '以最終主張、證據和視覺記憶點完成收束。',
    preview: 'closing',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '語句主導的構圖，只保留最少必要背景。',
    preview: 'quote',
    prompt:
  ...
  },
  {
    ...
    descriptionZh: '用字體、尺度和一條支撐線索來呈現重點表達。',
    preview: 'quote',
    prompt:
