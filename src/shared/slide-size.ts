...
export const SLIDE_SIZE_PRESETS: readonly SlideSizePreset[] = [
  { id: 'wide-16-9', label: '寬屏 16:9', width: 1600, height: 900 },
  { id: 'vertical-9-16', label: '豎屏 9:16', width: 900, height: 1600 },
  { id: 'standard-4-3', label: '標準 4:3', width: 1600, height: 1200 },
  { id: 'square-1-1', label: '方圖 1:1', width: 1200, height: 1200 },
  { id: 'vertical-3-4', label: '豎版 3:4', width: 1200, height: 1600 },
  { id: 'xiaohongshu-note', label: '小紅書', width: 1242, height: 1660 }
] as const
...
export const PPTX_SLIDE_SIZE_ERROR =
  '當前 PPTX 導出僅支持 16:9 和 4:3。請使用這兩種演示尺寸，或導出 PNG/PDF/視頻。'
